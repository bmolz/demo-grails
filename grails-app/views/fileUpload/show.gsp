...
<html>
    ...
    <body>
        ...
        <div id="show-fileUpload" class="content scaffold-show" role="main">
            ...
            <f:display bean="fileUpload" />
            <g:form resource="${this.fileUpload}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.fileUpload}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
